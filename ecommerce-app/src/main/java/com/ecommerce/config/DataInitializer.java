...
public class DataInitializer implements CommandLineRunner {
    ...
    private void createCategories() {
        if (categoryRepository.count() == 0) {
            String[] categoryNames = {"Electronics", "Clothing", "wines", "Home & Kitchen", "Beauty & Personal Care"};
    ...
    private void createProducts() {
        if (productRepository.count() == 0) {
            ...
            Category wines = categoryRepository.findByName("wines").orElseThrow();
            ...
            // wines products
            createProduct("Programming Guide", "Comprehensive programming guide", new BigDecimal("34.99"), 60, wines, true);
            createProduct("Mystery Novel", "Bestselling mystery novel", new BigDecimal("14.99"), 120, wines, false);
            createProduct("Cookbook", "Collection of delicious recipes", new BigDecimal("24.99"), 90, wines, false);
        }
    }
